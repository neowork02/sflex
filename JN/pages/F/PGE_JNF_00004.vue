    ...
    <sui-page-header :page-id="this.$options.name" />
        <div class="modal-title mb45"></div>
          <div class="modal-body">            
            ...
            <real-grid ref="pgeJnf00004" grid-id="pgeJnf00004" grid-root="/lib"
...
export default {
  ...
  mounted() {    
    ...
    //grid 초기화
    ({"gridView":this.gvEL, "dataProvider":this.dpEL } =  this.$refs.pgeJnf00004.initGrid());

    // grid style set 
    this.$refs.pgeJnf00004.setFitStyle("even");
  },
  computed: {
  ...
  methods: {
    ...
    grdELRendered(provider, view) {
      this.$refs.pgeJnf00004.RealGridJS.setRootContext("/");
    },
    fnsearch() {
      //this.dpEL.clearRows();
      ...
      http.request(this.$options.name, "DTS_JNF_00003", {
          ...
          if (res.data) {
            ...
            if (resData.length > 0) {
              ...
              this.$refs.pgeJnf00004.setRows(this.grdELDataList);
