<template>
  <sui-page>
    <sui-page-header :title="$t('MSG_TIT_ANNM_MDFC')" />
    <sui-page-contents>
      <div class="comm_view_wrap">
        ...
        <div class="row">
          ...
          <div class="col-xs-5">
            <sui-checkbox v-model="emergency">
              {{ $t('MSG_TXT_UGRN') }}
            </sui-checkbox>
            <div class="comp_spacing" />
            <sui-checkbox v-model="notice">
              {{ $t('MSG_TXT_ANNM') }}
            </sui-checkbox>
          </div>
          <div class="col-xs-1">
      ...
      <sui-web-editor
        ref="myEditor"
        :isViewer="false"
        :maxCharCount="pageInitialData.tbabRestrictSize"
        class="width100"
        height="220px"
    ...
    <sui-page-footer>
      <div class="comm_btn_wrap">
        <sui-button
          ...
          @click="validateAnouncementData('register')"
        >
          {{ $t('MSG_BTN_SAVE') }}
        </sui-button>
      </div>
...
export default {
  name: 'PGE_CLB_00012', // eslint-disable-line vue/name-property-casing
  extends: BasePage,
  props: {},
};
</script>
